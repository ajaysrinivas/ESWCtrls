...
namespace ESWCtrls
{
    ...
    public class Script : WebControl
    {
        ...
        internal static void PreRenderComplete(Page page)
        {
            ...
            if (s._startScripts.Count > 0)
            {
                ...
                ScriptManager.RegisterStartupScript(s, s.GetType(), s.ID, sb.ToString(), true);

                s._startScripts.Clear();
            }
        }
